...
// Creating action types for each of the function
...
// Creating and returning back the action object
...
// Creating actions for SignOut Form ( Here the signout doesn't need the payload)

export const signOutStart = withMatcher ((): SignOutStart =>
  createAction(USER_ACTION_TYPES.SIGN_OUT_START));

// Here the success will be set to null
export const signOutSuccess = withMatcher ((): SignOutSuccess =>
  createAction(USER_ACTION_TYPES.SIGN_OUT_SUCCESS));

// Fail alway need error as payload
